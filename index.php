...
<head>
  ...
  <meta name="author" content="Tahir Malik">
...
<body style="background-image: url('./images/qr-code-bg.jpg'); background-repeat: no-repeat; background-size: cover;">
<?php
...
?>
  <div class="container">
    <div class="card card-login mx-auto mt-5" style="background: rgba(0,0,0,0.7);">
      <div class="card-body">
        <center><img src="images/camera-svgrepo.svg" class="image image-responsive" height="150" width="150"></center>
        <br />
